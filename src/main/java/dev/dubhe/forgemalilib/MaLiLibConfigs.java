...
import dev.dubhe.forgemalilib.config.ConfigUtils;
import dev.dubhe.forgemalilib.config.IConfigHandler;
import dev.dubhe.forgemalilib.config.IConfigValue;
import dev.dubhe.forgemalilib.config.options.ConfigBoolean;
import dev.dubhe.forgemalilib.config.options.ConfigHotkey;
