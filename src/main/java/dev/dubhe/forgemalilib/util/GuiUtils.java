...
import dev.dubhe.forgemalilib.interfaces.ICoordinateValueModifier;
import net.minecraft.client.Minecraft;
import net.minecraft.client.gui.screens.Screen;
import net.minecraft.core.BlockPos;
import net.minecraft.world.phys.Vec3;
import dev.dubhe.forgemalilib.gui.GuiBase;
import dev.dubhe.forgemalilib.gui.GuiTextFieldDouble;
import dev.dubhe.forgemalilib.gui.GuiTextFieldGeneric;
import dev.dubhe.forgemalilib.gui.GuiTextFieldInteger;
